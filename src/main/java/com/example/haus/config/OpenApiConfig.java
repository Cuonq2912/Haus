...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI(@Value("${openapi.service.title}") String title,
        ...
        return new OpenAPI().servers(List.of(new Server().url(serverUrl).description("Server Initial")))
                .info(new Info().title(title).description("API Documents").version(version).license(
