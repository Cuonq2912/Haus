...
public class GlobalExceptionHandler {
    ...
    @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, examples = @ExampleObject(name = "Handle exception when the data input valid (@Request Body, @RequestParam, @PathVariable)", description = "Handle Bad Request", value = """
            {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "400", description = "Unauthorized", content = {
            @Content(mediaType = APPLICATION_JSON_VALUE, examples = @ExampleObject(name = "400 Response", summary = "Handle exception when authenticated failed", value = """
                    {
    ...
    @ApiResponse(responseCode = "404", description = "Bad Request", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, examples = @ExampleObject(name = "404 response", description = "Handle exception when resource not found", value = """
            {
                "timestamp": "2023-10-19T06:07:35.321+00:00",
                "status": 404,
                "path": "/api/v1/...",
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "403", description = "Forbidden", content = {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "409", description = "Conflict", content = {
    ...
    @ResponseStatus(BAD_REQUEST)
    @ApiResponses(value = { @ApiResponse(responseCode = "404", description = "Bad Request", content = {
            @Content(mediaType = APPLICATION_JSON_VALUE, examples = @ExampleObject(name = "404 Response", summary = "Handle exception when upload file failed", value = """
                    {
                      "timestamp": "2023-10-19T06:07:35.321+00:00",
                      "status": 404,
                      "path": "/api/v1/...",
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "429", description = "Too Many Requests", content = {
    ...
    public ErrorResponse handleRateLimitExceededException(RateLimitExceededException e, WebRequest webRequest) {
        ...
        errorResponse.setMessage(
                String.format("Rate limit exceeded. Please retry after %d seconds.", e.getRetryAfterSeconds()));
        return errorResponse;
    }
    ...
    @ResponseStatus(BAD_REQUEST)
    @ApiResponses(value = { @ApiResponse(responseCode = "400", description = "File Validation Failed", content = {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "500", description = "Internal Server Error", content = {
