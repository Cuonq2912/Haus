...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserResponseDto updateDetailProfile(ConfirmPasswordUpdateUserRequestDto requestDto,
    ...
    public UserResponseDto uploadAvatar(MultipartFile file, Authentication authentication) throws IOException {
        ...
        try {
            ...
            Map<String, Object> uploadParams = ObjectUtils.asMap("folder", "haus/avatars", "public_id", safeFilename,
                    "resource_type", "image", "overwrite", true, "transformation", "w_400,h_400,c_fill,q_auto");
