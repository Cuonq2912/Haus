...
public class AuthController {
    ...
    public ResponseEntity<ResponseData<LoginResponseDto>> login(@Valid @RequestBody LoginRequestDto loginRequestDto,
        ...
        return ResponseUtil.success(SuccessMessage.Auth.LOGIN_SUCCESS, result);
    }
    ...
    public ResponseEntity<ResponseData<RefreshTokenResponseDto>> refresh(
        ...
        return ResponseUtil.success(SuccessMessage.Auth.REFRESH_TOKEN_SUCCESS, result);
    }
    ...
    public ResponseEntity<ResponseData<UserResponseDto>> verify(
            @Valid @RequestBody VerifyOtpRequestDto verifyOtpRequestDto) {
        return ResponseUtil.success(HttpStatus.CREATED, SuccessMessage.Auth.VERIFY_OTP_REGISTER_SUCCESS,
    ...
    public ResponseEntity<ResponseData<Void>> verifyToResetPassword(@Valid @RequestBody VerifyOtpRequestDto request) {
        ...
        return ResponseUtil.success(HttpStatus.OK, SuccessMessage.Auth.VERIFY_OTP_TO_RESET_PASSWORD_SUCCESS);
    }
    ...
    public ResponseEntity<ResponseData<UserResponseDto>> resetPassword(
