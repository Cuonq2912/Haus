...
public class FavoriteController {
    ...
    @Operation(
            ...
            description = "Thêm sản phẩm vào danh sách yêu thích của user.",
    ...
    @Operation(
            ...
            description = "Xóa sản phẩm khỏi danh sách yêu thích của user.",
            security = @SecurityRequirement(name = "Bearer Token")
    )
    ...
    @Operation(
            ...
            description = "Lấy danh sách tất cả sản phẩm yêu thích của user với phân trang. " +
    ...
    public ResponseEntity<?> getFavorites(
            ...
            @Parameter(description = "Số items trên mỗi trang", example = "20")
            Integer pageSize) {
    ...
    @Operation(
            summary = "Kiểm tra sản phẩm đã yêu thích",
            description = "Kiểm tra xem sản phẩm có trong danh sách yêu thích của user hay không.",
            security = @SecurityRequirement(name = "Bearer Token")
    )
