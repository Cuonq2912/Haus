...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    Page<Review> findByProductIdAndRating(@Param("productId") Long productId, @Param("rating") Integer rating,
            Pageable pageable);

    @Query("SELECT r " + "FROM Review r " + "WHERE r.deletedAt IS NULL " + "AND r.isHidden = false "
